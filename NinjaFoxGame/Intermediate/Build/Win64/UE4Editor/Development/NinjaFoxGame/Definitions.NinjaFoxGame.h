#undef NINJAFOXGAME_API
#undef NINJAFOXGAME_VTABLE
...
#define UE_PROJECT_NAME NinjaFoxGame
...
#define NINJAFOXGAME_VTABLE DLLEXPORT_VTABLE
#define NINJAFOXGAME_API DLLEXPORT
